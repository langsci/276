...
variation (\citealt{Adger2006} \emph{et seq.}).}

\maketitle

\rohead{\thechapter\hspace{0.5em}Rethinking the reach of categorical
constraints}
...
and the head-directionality of VP and TP\@. In \Cref{sec-30:key:2}, I introduce
FOFC and demonstrate that the surface frequencies predicted by the
Combinatorial Variability ap\-proach change if \gls{FOFC}\is{Final-over-Final Condition} is held to be valid.
...
\ea\label{bkm:Ref341518219}\ili{Spanish}\\
...
\ea \ili{Spanish}\\
    ...
    \begin{tikzpicture}[baseline, scale=.9]
        ...
        \draw [arrow, bend left=40] (t.south) to (goal.south);
