...
\abstract{This work aims to reconcile the atomic objects of study typically
    ...
    \enquote{Incompatibility Problem}, the observation that studying comparative
    ...
    primitives. We then address the \enquote{Granularity Mismatch Problem} and
...
individual variation attested in reality. \sectref{sec:key:3} then aims to
...
\sectref{sec:key:4} concludes and presents some suggestions for future work on
this topic.
