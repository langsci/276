...
\lspbottomrule
\end{tabular}}
\caption{Distribution of adverbial and argument fronting in full clausal \glspl{RC}\is{relative clauses} in \ili{English}. ✔: allowed; (✔): allowed subject to restrictions; *: not allowed.\label{tab:2}}
\end{table}
