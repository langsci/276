...
\abstract{%
This chapter is concerned with the syntactic size of finite and infinitival
...
whatever is relativised.  This will become apparent in \Cref{sec:key:02.3}.

The structure of this chapter is as follows. The adverbial
fronting\is{fronting!adverbial} data is laid out in \Cref{sec:key:02.2}, whilst
the argument fronting data and the aforementioned \isi{categorial distinctness}
effect are presented in \Cref{sec:key:02.3}. My analysis is laid out in
\Cref{sec:key:02.4} and suggests a close formal relation between relativisation
and topicalisation\is{topicalization} (at least in finite \gls{RC}\is{relative clauses}
contexts). \Cref{sec:key:02.5} concludes.
...
\ea\label{ex:key:2.18}
    ...
    \z
\z
\emph{that}-\glspl{RC} do not permit \is{pied-piping}pied-piping of prepositions at all so (\ref{ex:key:2.19}b) and
(\ref{ex:key:2.20}b) are ungrammatical independently of adverbial fronting\is{fronting!adverbial} and adverbial
negative preposing respectively.

\ea\label{ex:key:2.19}
    \ea[]{I met a man that \textbf{next year} Mary might (actually) grant a second date to.}
    \ex[*]{I met a man to that (\textbf{next year}) Mary might (actually) grant a second date.}
    \z
\z
\ea\label{ex:key:2.20}
    \ea[]{I met a man that \textbf{under no circumstances} would Mary ever grant a first date to.}
    \ex[*]{I met a man to that (\textbf{under no circumstances}) would Mary ever grant a first date.}
    \z
\z
...
\ea\label{ex:key:2.21}
    \ea[*]{I met a man \textbf{next year} Mary might (actually) date.}
    \ex[*]{I bought a dress \textbf{next year} Mary might (actually) wear.}
    \z
\z
\ea\label{ex:key:2.22}
    \ea[*]{I met a man (\textbf{next year}) might (actually) date Mary.}
    \ex[*]{I bought a dress (\textbf{next year}) might (actually) make Mary popular.}
    \z
\z
\ea\label{ex:key:2.23}
    \ea[*]{I met a man \textbf{under no circumstances} would Mary ever date.}
    \ex[*]{I bought a dress \textbf{under no circumstances} would Mary ever wear.}
    \z
\z
\ea\label{ex:key:2.24}
    \ea[*]{I met a man (\textbf{under no circumstances}) would (ever) go out with Mary.}
    \ex[*]{I bought a dress (\textbf{under no circumstances}) would (ever) make Mary popular.}
    \z
\z
\emph{Ø-}RCs do not permit \is{pied-piping}pied-piping of prepositions in general. Hence (\ref{ex:key:2.25}b)
and (\ref{ex:key:2.26}b) are ungrammatical independently of adverbial fronting\is{fronting!adverbial} or adverbial
negative preposing respectively.

\ea\label{ex:key:2.25}
    \ea[*]{I met a man \textbf{next year} Mary might (actually) grant a second date to.}
    \ex[*]{I met a man to (\textbf{next year}) Mary might (actually) grant a second date.}
    \z
\z
\ea\label{ex:key:2.26}
    \ea[*]{I met a man \textbf{under no circumstances} would Mary ever grant a first date.}
    \ex[*]{I met a man to (\textbf{under no circumstances}) would Mary ever grant a first    date.}
    \z
\z
...
fronting\is{fronting!adverbial}} and adverbial negative preposing is permitted, as in \eqref{ex:key:2.27} and \eqref{ex:key:2.28}
respectively.
...
\ea\label{ex:key:2.29}
    \ea[??]{Mary’s the woman to whom \textbf{next week} for you to hand these documents.}
    \ex[*]{Mary’s the woman to whom for you \textbf{next week} to hand these documents.}
    \z
\z
The same seems to be true for adverbial negative preposing, as in \eqref{ex:key:2.30}.

\ea\label{ex:key:2.30}
    \ea[??]{Mary’s the woman to whom \textbf{under no circumstances} for you to ever hand these documents.}
    \ex[*]{Mary’s the woman to whom for you \textbf{under no circumstances} to ever hand these documents.}
    \z
\z
...
\ea\label{ex:key:2.31}
    \ea[?*]{I met a man \textbf{next year }for you to bring to the party.}
    \ex[*]{I met a man for you \textbf{next year }to bring to the party.}
    \z
\z

\ea\label{ex:key:2.32}
    \ea[*]{I met a man \textbf{under no circumstances} for you to ever bring to the party.}
    \ex[*]{I met a man for you \textbf{under no circumstances} to ever bring to the party.}
    \z
\z
...
\ea
[*]{Mary’s the woman to (\textbf{next week}) for you to hand these documents.}\label{ex:key:2.33}
\z

\ea
[*]{Mary’s the woman to (\textbf{under no circumstances}) for you to ever hand these documents.}\label{ex:key:2.34}
\z
...
\ea
[*]{I met a man \textbf{next year} to bring to the party.}\label{ex:key:2.35}
\z

\ea
[*]{I met a man \textbf{under no circumstances} to ever bring to the party.}\label{ex:key:2.36}
\z
...
\ea
[*]{Mary’s the woman to (\textbf{next }\textbf{week}) to hand these documents.}\label{ex:key:2.37}
\z

\ea
[*]{Mary’s the woman to (\textbf{under no circumstances}) to ever hand these documents.}\label{ex:key:2.38}
\z
...
out in \Cref{sec:key:02.1}, \citegen{Haegeman2012} analysis is based on cases where
...
\ea\label{ex:key:2.40}
    \ea[*]{I met a man, \textbf{a second date}, to whom Mary might actually grant.}
    \ex[*]{I bought a car, \textbf{muddy shoes}, in which I would never allow.}
    \z
\z
...
\ea\label{ex:key:2.41}
    \ea[?*]{I met a man who(m), \textbf{a second date}, Mary might actually grant to.}
    \ex[?*]{I bought a car which, \textbf{muddy shoes}, I would never allow in.}
    \z
\z
The same effect can be seen when it is the \is{fronting!of arguments}fronted argument rather than the
relative pronoun that has the option of \is{pied-piping}pied-piping a preposition. In \eqref{ex:key:2.42}, the
fronted argument has \is{pied-piping}pied-piped a preposition and the result is acceptable,
whilst in \eqref{ex:key:2.43}, it has not \is{pied-piping}pied-piped a preposition and the result is
unacceptable.
...
\ea
[*]{I witnessed the second date which, \textbf{that man}, Mary should never have granted to.}\label{ex:key:2.43}
\z
...
examples aside for now but will return to them in \Cref{sec:key:02.4.4}.
...
original).\footnote{\textcite[Ch.\ 2, note 6]{Haegeman2012} notes via personal
    ...
    as in (iii). See \Cref{sec:key:02.4.4} for discussion.
...
\ea\label{ex:key:2.45}
    \ea[??]{the man to whom, \textbf{that book}, I gave}
    \ex[*]{the man who, \textbf{that book}, gave to me}
    \z
\z
\ea\label{ex:key:2.46}
    \ea[?]{a man to whom, \textbf{liberty}, we should never grant\footnotemark}
    \ex[*]{a man who, \textbf{liberty}, should never grant to us}
    \z
\z
\footnotetext{(\ref{ex:key:2.46}a) is adapted from \textcite[17]{Baltin1982}. Baltin
judges it as acceptable, but notes that not all speakers find it totally
acceptable.}
%
However, observe that the non-subject \gls{RC}\is{relative clauses} examples in (\ref{ex:key:2.45}a) and (\ref{ex:key:2.46}a) satisfy
categorial distinctness whilst the subject \gls{RC}\is{relative clauses} examples in (\ref{ex:key:2.45}b) and (\ref{ex:key:2.46}b) do
not. If the \isi{categorial distinctness} effect is responsible for the
ungrammaticality of (\ref{ex:key:2.45}b) and (\ref{ex:key:2.46}b), the prediction is that \is{fronting!of arguments}fronted arguments
...
\ea\label{ex:key:2.47}
    \ea[*]{I met a man who, \textbf{Mary}, might actually grant a second date to.}
    \ex[*]{I bought a car which, \textbf{children}, can give hours of entertainment to.}
    \z
\z

\ea\label{ex:key:2.48}
    \ea[?]{I met a man who, \textbf{to Mary}, might actually grant a second date.}
    \ex[]{I bought a car which, \textbf{to children}, can give hours of entertainment.}
    \z
\z
...
\ea\label{ex:key:2.50}
    \ea [*]{I met a man who(m), \textbf{no woman}, would I ever recommend to (as a date).}
    \ex [*]{I bought a dress which, \textbf{no woman}, would I ever give to (as a present).}
    \ex [*]{I met a man who, \textbf{no woman}, would ever give roses to.}
    \ex [*]{I bought a dress which, \textbf{no woman}, would ever be given to (as a present).}
    \z
\z
...
\ea\label{ex:key:2.52}
    \ea[*]{I met a man who(m), \textbf{no advice} would I ever give to.}
...
schematised in \tabref{tab:1}.%\footnote{\citet[306]{Rizzi1997} claims that,
...
\ea\label{ex:key:2.54}
    \ea[*]{I bought a dress that, \textbf{Mary}, I might consider giving to (as a present).}
    \ex[*]{I bought a dress that, \textbf{Mary}, could be given to (as a present).}
    \ex[*]{I bought a car that, \textbf{children}, would give hours of entertainment to.}
    \z
\z
...
\ea\label{ex:key:2.56}
    \ea[*]{I bought a dress that, \textbf{no woman}, would I ever give to (as a present).}
    \ex[*]{I bought a dress that, \textbf{no woman}, would ever be given to (as a present).}
    \z
\z
...
\ea\label{ex:key:2.57}
    \ea[*]{I bought a car that, \textbf{muddy shoes}, I would never allow in.}
    \ex[*]{I bought a car that, \textbf{hours of entertainment}, would give to children.}
    \ex[*]{I bought a car that, \textbf{the children}, can keep entertained.}
    \z
\z
\ea\label{ex:key:2.58}
    \ea[??]{I bought a car that, \textbf{not a single muddy shoe} would I ever allow in.}
    \ex[*]{I bought a car that, \textbf{not a single hour of entertainment}, would ever give to any child.}
    \ex[*]{I bought a car that, \textbf{no child}, can keep entertained.}
    \z
\z
...
\ea\label{ex:key:2.59}
    \ea[*]{I met a man, \textbf{Mary}, I might recommend to (as a date).}
    \ex[*]{I bought a dress, \textbf{Mary}, I could give to (as a present).}
    \z
\z
\ea\label{ex:key:2.60}
    \ea[*]{I met a man, \textbf{to Mary}, I might recommend (as a date).}
    \ex[*]{I bought a dress, \textbf{to Mary}, I could give (as a present).}
    \z
\z
...
\ea\label{ex:key:2.61}
    \ea[*]{I met a man, \textbf{no woman} would I ever recommend to (as a date).}
    \ex[*]{I bought a dress, \textbf{no woman} would I ever give to (as a present).}
    \z
\z
\ea\label{ex:key:2.62}
    \ea[*]{I met a man, \textbf{to no woman} would I ever recommend (as a date).}
    \ex[*]{I bought a dress, \textbf{to no woman} would I ever give (as a present).}
    \z
\z
...
\ea\label{ex:key:2.63}
    \ea[*]{I found an ideal venue in which, \textbf{Mary}, to propose to.}
    \ex[*]{I found an ideal venue in which, \textbf{Mary}, for you to propose to.}
    \ex[*]{I found an ideal venue in which for you, \textbf{Mary}, to propose to.}
    \z
\z
\ea\label{ex:key:2.64}
    \ea[*]{I found an ideal venue in which, \textbf{to} \textbf{Mary}, to propose.}
    \ex[*]{I found an ideal venue in which, \textbf{to} \textbf{Mary}, for you to propose.}
    \ex[*]{I found an ideal venue in which for you, \textbf{to} \textbf{Mary}, to propose.}
    \z
\z
...
\ea\label{ex:key:2.65}
    \ea[*]{This is a place in which, \textbf{no man}, to ever give one’s real name to.}
    \ex[*]{This is a place in which, \textbf{no man}, for you to ever give your real name to.}
    \ex[*]{This is a place in which for you, \textbf{no man}, to ever give your real name to.}
    \z
\z
\ea\label{ex:key:2.66}
    \ea[*]{This is a place in which, \textbf{to no man}, to ever give one’s real name.}
    \ex[*]{This is a place in which, \textbf{to no man}, for you to ever give your real name.}
    \ex [*]{This is a place in which for you, \textbf{to no man}, to ever give your real name.}
    \z
\z
...
\ea\label{ex:key:2.67}
    \ea[*]{I found an ideal venue, \textbf{Mary}, for you to propose to in.}
    \ex[*]{I found an ideal venue for you, \textbf{Mary}, to propose to in.}
    \z
\z
\ea\label{ex:key:2.68}
    \ea[*]{I found an ideal venue, \textbf{to Mary}, for you to propose in.}
    \ex[*]{I found an ideal venue for you, \textbf{to Mary}, to propose in.}
    \z
\z
The same applies to argument negative preposing.

\ea\label{ex:key:2.69}
    \ea[*]{I saw a venue, \textbf{no woman}, for one to propose to in.}
    \ex[*]{I saw a venue for one, \textbf{no woman}, to propose to in.}
    \z
\z
\ea\label{ex:key:2.70}
    \ea[*]{I saw a venue, \textbf{to no woman}, for one to propose in.}
    \ex[*]{I saw a venue for one, \textbf{to no woman}, to propose in.}
    \z
\z
...
\ea
[*]{I found an ideal venue, \textbf{Mary}, to propose to in.}\label{ex:key:2.71}
\z
\ea
[*]{I found an ideal venue, \textbf{to Mary}, to propose in.}\label{ex:key:2.72}
\z
The same applies to argument negative preposing.

\ea
[*]{I saw a venue, \textbf{no woman}, for one to propose to in.}\label{ex:key:2.73}
\z
\ea
[*]{I saw a venue, \textbf{to no woman}, for one to propose in.}\label{ex:key:2.74}
\z
...
Putting the conclusions from \Cref{sec:key:02.2} and \Cref{sec:key:02.3} together, we have the empirical
situation regarding the distribution of adverbial and argument
fronting\is{fronting!adverbial}\is{fronting!of arguments} in
English \glspl{RC}\is{relative clauses} shown in \tabref{tab:2} (note that the terms \emph{adverbial
...
\caption{Distribution of adverbial and argument fronting in full clausal \glspl{RC}\is{relative clauses} in \ili{English}.}\label{tab:2}
\end{table}
...
\ea
[*]{the year in which, that book, TO JOHN Mary gave}\label{ex:key:2.84}
\z
...
\ea\label{ex:key:2.87}
    \ea[?*]{a man to whom, \textbf{unfettered liberty} we would never grant \textbf{it}}
    \ex[?]{a man \textbf{to whom}, unfettered liberty we would never grant \textbf{to him}}
    \z
\z
\ea\label{ex:key:2.88}
    \ea[?*]{a man to whom, \textbf{this book} Mary would happily give \textbf{it}}
    \ex[?]{a man \textbf{to whom}, this book Mary would happily give \textbf{to him}}
    \z
\z
...
\ea\label{ex:key:2.89}
    \ea[]{This present, TO MARY I would give.}
    \ex[*]{This present, MARY I would give to.}
    \z
\z
\ea\label{ex:key:2.90}
    \ea[]{To Mary, THIS PRESENT I would give.}
    \ex[*]{Mary, THIS PRESENT I would give to.}
    \z
\z
(\ref{ex:key:2.89}) shows that, if the \isi{topic} phrase is a DP, the
\isi{focus} phrase cannot be a DP, as in (\ref{ex:key:2.89}b), and must be a
...
\ea\label{ex:key:2.91} Infinitival \emph{wh}-\glspl{RC}
    \ea[*]{the man \textbf{whom} to talk to}
    \ex[]{the man \textbf{to whom} to talk}
    \z
\z
...
\ea\label{ex:key:2.92} Infinitival \emph{wh}-\glspl{RC}
    \ea[*]{[\tss{DP} \textbf{D} [\tss{NP} N=RC head [\tss{CP} [\textbf{\tss{DP}} \textbf{\emph{wh}-relative pronoun} ] [\tss{C’} C [\tss{TP} \dots{}]]]]]}
    \ex[\hphantom{*}]{[\tss{DP} \textbf{D} [\tss{NP} N=RC head [\tss{CP}
        [\textbf{\tss{PP}} \textbf{P} [\textbf{\tss{DP}}
    \textbf{\emph{wh}-relative pronoun} ]] [\tss{C’} C [\tss{TP} \dots]]]]]}
    \z
\z
...
\ea\label{ex:key:2.93} Infinitival \emph{wh}-\glspl{RC}
    \ea[*]{[\tss{DP} D [\tss{TopP} \textbf{[\tss{DP} RC head]} Top [\tss{FocP} [\textbf{\tss{DP}} \textbf{\emph{wh}}\textbf{{-relative pronoun ]}} Foc [\tss{FinP} Fin [\tss{TP} \dots{}]]]]]}
    \ex[\hphantom{*}]{[\tss{DP} D [\tss{TopP} \textbf{[\tss{DP} RC head]} Top
        [\tss{FocP} \textbf{[\tss{PP} P [\tss{DP} \emph{wh}-relative pronoun ]]} Foc [\tss{FinP} Fin [\tss{TP}
\dots{}]]]]]}
    \z
\z
...
\eqref{ex:key:2.93}, I have shown the \gls{RC}\is{relative clauses} head as being in SpecTopP\@. This
...
\ea\label{ex:key:2.95} Finite \emph{wh}-\glspl{RC}
    \ea {}[\tss{DP} D [\tss{ForceP} \textbf{[\tss{DP} RC head]} Force [\tss{TopP} [\textbf{\tss{DP} \emph{wh}-relative pronoun}] Top [\tss{FocP} Foc [\tss{FinP} Fin [\tss{TP} \dots{}]]]]]
    \ex {}[\tss{DP} D [\tss{ForceP} \textbf{[\tss{DP} RC head]} Force
    [\tss{TopP} \textbf{[\tss{PP} P [\tss{DP} \emph{wh}-relative pronoun]]} Top [\tss{FocP} Foc [\tss{FinP} Fin [\tss{TP}  \dots{}]]]]]
    \z
\z
...
\ea\label{ex:key:2.96}
    I met a man \textbf{with whom}, \textbf{about linguistics}, I could talk all day.
\z
In \eqref{ex:key:2.96}, the relative pronoun\is{relative pronouns} and \emph{linguistics} have both \is{pied-piping}pied-piped a
...
marginally possible to front the \gls{RC}\is{relative clauses} subject in an example like \eqref{ex:key:2.97}.

\ea[?]{I met a man with whom, MARY, about linguistics, could talk all day.}\label{ex:key:2.97}
\z
...
pronoun/operator and fronted (focussed)\is{focus} argument in finite \emph{wh}- and
\emph{that}-RCs; (ii) between \isi{topic} and \isi{focus} in non-RC contexts; and (iii)
between the \gls{RC}\is{relative clauses} head and relative pronoun/operator in infinitival
