...
\renewcommand{\lsCollectionPaperHeaderTitle}{\thechapter\hspace{0.5em}Notes on the Merge position of demonstratives}
...
\rohead{\thechapter\hspace{0.5em}Notes on the Merge position of demonstratives}
...
head noun \parencite[§9]{KutschLojenga1994} and deictic\is{deixis} \isi{demonstratives} are
...
As apparent from \eqref{ex:key:09.2}, the two types of \isi{demonstratives} can
...
deictic\is{deixis} demonstrative of \eqref{ex:key:09.2} is merged below the
...
Komnzo in addition to deictic\is{deixis} \isi{demonstratives} has one demonstrative, \emph{ane},
...
\ea\label{ex:key:09.3} \ili{Komnzo} \parencite[129]{Dohler2016}\\
...
\ea \ili{Kaere} \parencite[120]{Klamer2014}\label{ex:key:09.4}\\
	\gll kunang   masik     utug \textbf{erang} \textbf{gu} \\
        child  male three \textbf{\Dem\tss{anaphoric}} \textbf{that}\\
	\glt ‘those three boys (mentioned earlier)’
\z

\ea \ili{Loniu} \parencite[99]{Hamel1994}\label{ex:key:09.5}\\
    \gll \dots{} hetow    law        a  iy  \textbf{nropo} \textbf{itiyen} ... \\
		{} \Tpl.\Cl{} \Rel{} \Poss{} \Tsg{} \textbf{\Dem{}\tss{anaphoric}} \textbf{\Dem{}\tss{deictic}} {}\\
...
\ili{Kita\-lin\-ga} (\citealt{Paluku1998}) instead show post-nominally
the same order shown pre-nominally by \ili{Ngiti}: NP $>$ deictic\is{deixis} demonstrative
...
\ea\label{ex:key:09.6a}\ili{Gayo} \parencite[225]{Eades2005})\\
		\gll Serule-\textbf{ni-ne}\\
			    Serule-\textbf{this-earlier}\\
		\glt ‘this Serule’ [Serule-this-MENTIONED earlier] (the aforementioned Serule)\\
        \ex\label{ex:key:09.6b}\ili{Nias} \parencite[579]{Brown2005})\\
		\gll Ba  si'ulu  wa  e  nama-da  \textbf{andre} \textbf{nomema'e}!?\\
            \Cnj{} noble \Dptcl{} \Dptcl{} father:\Mut{}-\Fpl.\Incl.\Poss{} \textbf{\Dem{}\tss{Deictic}} \textbf{\Dem{}\tss{anaphoric}}\\
		\glt ‘And you mean that ancestor you’ve been talking about was a noble!?’
        \ex\label{ex:key:09.6c}\ili{Samba Leko} \parencite[173]{Fabre2004}\\
		\gll b\=a?–\=a \textbf{yê} \textbf{d\=o}\\
			    iron \textbf{\Dem{}\tss{deictic}} \textbf{\Dem{}\tss{anaphoric}}\\
		\glt ‘that iron we talked about’ [our translation]
    \ex\label{ex:key:09.6d}\ili{Kitalinga} \parencite[203]{Paluku1998}\\
		\gll omumelo  ɤú-\textbf{nì-lá}\\
            throat  \textsc{?}-\textbf{\Dem{}\tss{deictic}}-\textbf{\Dem{}\tss{anaphoric}}\\
...
examples of the order of the two types of \isi{demonstratives} in \eqref{ex:key:09.8}:

\ea\label{ex:key:09.7}
(DEM\tss{deictic}) (NPOSS PROPOSS-) N (NMOD) (ADJ/V) (QUANT) (DEM\tss{anaphoric})
\z

\ea\label{ex:key:09.8}
	\ea Abui \parencite[111]{Kratochvil2007}\\
		\gll \textbf{oro} fala\\
			    \textbf{\Dem{}\tss{deictic}} house\\
		\glt ‘that house over there (far from us)’
	\ex Abui \parencite[114]{Kratochvil2007}\\
		\gll fala \textbf{to}\\
			    house \textbf{\Dem{}\tss{anaphoric}}\\
...
the noun (cf.~(\ref{ex:key:09.9}a))\footnote{\enquote{\emph{núŋò} is deictic\is{deixis}, and may be
accompanied by pointing or a similar gesture} \parencite[162]{Heath2008}.} and
the anaphoric one precedes it (cf.~(\ref{ex:key:09.9}b)),\footnote{\enquote{Unlike deictic\is{deixis}
...
higher than proximal \isi{demonstratives}, as shown in\eqref{ex:key:09.14}:
...
\ea \ili{Tigre} (\citealt{Dryer2013}, after \citealt[45]{Raz1983})\label{ex:key:09.15}
	\ea
