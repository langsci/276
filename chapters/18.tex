...
\begin{figure}
\caption{{\color{red}Please provide a caption}\label{fig:18.1}}
...
\begin{figure}
	\caption{\color{red}Please provide a caption and reference the figure in the text.\label{fig:18.2}}
...
\begin{figure}
    \caption{{\color{red}Please provide a caption and reference the fiure in the text.}\label{fig:18.3}}
...
root, ceteris paribus. A\tsp{min} would have its [\emph{u}φ]
features checked via c-selection of N and its $[u\textsc{case}]$ feature valued
presumably via the chain 〈N\tsp{min}[u\textsc{case: }],
...
D-category\linebreak which historically derives from demonstratives and not
pronouns (as is the case with Romance). Given the approach I just outlined, the
N/D parameter is therefore independent from the C-orientation parameter for
cliticisation.
