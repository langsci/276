...
\ex \ili{Greek}\label{ex:key:01.5}\\
...
\begin{table}
\caption{The morphological paradigm of the \gls{RR} pronoun \emph{o opios-i opia-to opio}}\label{tab:key:2}
\begin{tabularx}{\textwidth}{lXXXXXX}
\lsptoprule
            & \multicolumn{3}{c}{Singular}                & \multicolumn{3}{c}{Plural}  \\\cmidrule(lr){2-4}\cmidrule(lr){5-7}
            & Masc            & Fem              & Neut           & Masc             & Fem              & Neut\\
...
\ex \ili{Greek}\label{ex:key:01.7}\\
...
\ea \ili{Greek}\label{ex:key:01.12}
	...
	\z
\ex \ili{Greek}\label{ex:key:01.13}
	\ea
...
\ex \ili{Greek}\label{ex:key:01.17}
    \ea[*]{
...
\ea \ili{Greek}\label{ex:key:01.19}
	...
	\z
\ex \ili{Greek}\label{ex:key:01.20}
	\ea
...
\subsection{Both free and restrictive relative pronouns are DPs}\label{sub:key:01.4.1}
...
\ex \ili{Greek}\label{ex:key:01.22}\\
...
\ex \ili{Greek}\label{ex:key:01.24}
	\ea
...
\ex \ili{Polish} \citep[88]{Caponigro2003}\label{ex:key:01.27}\\%27
...
\ex \ili{Greek}\label{ex:key:01.31}\\
