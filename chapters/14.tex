...
\eqref{ex:01.7}:\footnote{The \ili{English} translation of (\ref{ex:01.8text}a) and
...
\ea\label{ex:01.8text} Greek\\
    \ea[*]{
    \gll ðen θeli mono afta {ta opia} exis ala ke aftus \emph{tus opius} exis.\\
    ...
    \ex[]{
	\gll ðen θeli mono oti exis ala ke \emph{opjon} exis.\\
