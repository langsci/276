...
\eqref{ex-26:1}--\eqref{ex-26:2}. \textcite{Odainpress} in fact explicitly argues for their separation,
...
\ea\label{ex-26:1}The \glsdesc{CSC} -- Extraction out of Conjuncts\\
	Extraction out of conjuncts is disallowed.
\z

\ea\label{ex-26:2}The \glsdesc{CSC} – Extraction of Conjuncts\\
...
illustrated by \eqref{ex-26:9} and the latter by \eqref{ex-26:10}.
...
\ea\label{ex-26:14} cf.\ *Who did you see John and enemies of?
\z
...
\ea\label{ex-26:16} cf.\ *What did you file the book without reading?
\z

From the current perspective, \eqref{ex-26:15}--\eqref{ex-26:16} can be looked at on a par with
\eqref{ex-26:13}--\eqref{ex-26:14}. Just like the unacceptable case of extraction out of a conjunct in
...
\ea\label{ex-26:19} \ili{Serbo-Croatian}\\
    \ea
...
\ea\label{ex-26:20} \glsdesc{SC}\il{Serbo-Croatian}\\
    \ea
...
\ea\label{ex-26:23}\glsdesc{SC}\il{Serbo-Croatian}\\
...
in embedded clauses, even with \isi{coordination}).} Consider \eqref{ex-26:24}--\eqref{ex-26:25}, which are
...
\ea\label{ex-26:30} \ili{Galician} \parencite[81]{Uriagereka1988}
...
\ea\label{ex-26:31} \ili{Galician} \parencite[58]{Boskovic2016}
...
\ea\label{ex-26:32} \ili{Galician} \parencite[58]{Boskovic2016}
...
Consider again \eqref{ex-26:24}--\eqref{ex-26:25}. Just like in \eqref{ex-26:25} \isi{movement} of the head of the VP
...
extraction out of a conjunct. It turns out that it does. Consider \eqref{ex-26:34}--\eqref{ex-26:35}
(the \ili{Galician} data below are due to Juan Uriagereka, p.c.; \emph{a} in
\eqref{ex-26:34}--\eqref{ex-26:35} is a differential object
...
\ea\label{ex-26:35} \ili{Galician}\\
...
for \emph{wh}-movement in \eqref{ex-26:31}--\eqref{ex-26:32} and \eqref{ex-26:34}--\eqref{ex-26:35}. All the relevant cases
...
purposes).\footnote{\eqref{ex-26:32} is actually slightly awkward (meriting at most ?).
    ...
    second conjunct crossing the first conjunct, also a phrase (\eqref{ex-26:32} is in fact
...
parts of the \glsentrytext{CSC}, i.e.\ \eqref{ex-26:1}--\eqref{ex-26:2}, by proposing that both individual
...
proposed analysis thus captures the full paradigm in \eqref{ex-26:26}, \eqref{ex-26:27}, \eqref{ex-26:31}--\eqref{ex-26:32},
\eqref{ex-26:34}--\eqref{ex-26:35}, and \eqref{ex-26:37}: it captures the fact that \eqref{ex-26:27} and \eqref{ex-26:32} are better than
...
incorporation causes in \eqref{ex-26:34}--\eqref{ex-26:35}. In both cases we are dealing with
...
traditional adjunct itself.  As shown in \eqref{ex-26:31}--\eqref{ex-26:32}, the islandhood\is{islands}
...
\eqref{ex-26:24}--\eqref{ex-26:25}, we have seen that \isi{head movement} rescues extraction out of both
...
\eqref{ex-26:29}--\eqref{ex-26:30}: In all these cases the relevant head is *-marked due to extraction
...
the discussion of extraction of conjuncts, i.e.\ \eqref{ex-26:2}, aside above. In this
section, I will, however, make some brief remarks on extraction of conjuncts,
i.e.\ the status of \eqref{ex-26:2}, the reason being that the rescue-by-\gls{PF} deletion
mechanism, which I have appealed to above, turns out to be relevant to \eqref{ex-26:2}, as
...
\eqref{ex-26:2}, what is relevant is the islandhood\is{islands} of ConjP: the island that is crossed
...
\ea\label{ex-26:41} \ili{Japanese} \parencite{Odainpress}
    \ea[?]{
...
\eqref{ex-26:34}--\eqref{ex-26:35} with the possibility of extraction of a traditional conjunct in \eqref{ex-26:41}
...
islandhood is voided through \isi{movement} of island heads (cf.\ \eqref{ex-26:28}). As discussed
...
violations like \eqref{ex-26:4} seem to be worse than \isi{adjunct condition} violations like
\eqref{ex-26:5} (as noted above, the prediction is also borne out with \ili{Galician} \eqref{ex-26:31} and \eqref{ex-26:34},
