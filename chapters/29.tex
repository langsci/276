...
and argue, \emph{contra} \citet{Kayne1994}, that \isi{movement} of the first
...
\ea\label{kex}
    John\tss{i} is human beings [BOTH [[e\tss{i}] with Bill]]
\z
...
\eqref{ex:key:29.12} as an instance of DP \isi{movement}:\footnote{To be sure, there are various
...
\ea[\#]{%
    Sue is friends with Sy but Sy is not friends with Sue.}\label{ex:key:29.17}
\z
...
\ea\label{ex:key:29.21}
    \ea[???/*]{Both Sue and Sy fucked (with) each other}
    \ex[???/*]{Both Rosetta and Galileo collided with each other}
    \z
\z
...
\ea\label{ex:key:29.30} \ili{Greek}\\
...
\ea\label{ex:key:29.33} \ili{Greek}\\
...
\ea\label{ex:key:29.34} \ili{Greek}\\
...
\ea\label{ex:key:29.35} \ili{Greek}\\
...
\ea\label{ex:key:29.36} \ili{Greek}\\
...
\ea\label{ex:key:29.37} \ili{Greek}\\
...
\ea\label{ex:key:29.38} \ili{Greek}\\
...
\ea\label{ex:key:29.39} \ili{Greek}\\
...
\ea\label{ex:key:29.41} \ili{Greek}\\
...
\ea\label{ex:key:29.42} \ili{Greek}\\
...
\ea\label{ex:key:29.43} \ili{Greek}\\
...
\ea\label{ex:key:29.44} \ili{Greek}\\
...
\ea\label{ex:key:29.46} \ili{Greek}\\
...
\ea\label{ex:key:29.51} \ili{Greek}\\
...
\emph{with/me}-\isi{coordination} will not yield a distributive reading simply
...
different behaviour of \emph{and} and \emph{with}-\isi{coordination} in
